...
export default {
  ...
  plugins: [
    replace({
      ...
      // fix "jsonwebtoken" library using "process.version" for some reason, which makes the whole thing fail in the browser when it turns into "browser.version"
      "browser.version": '"8.0.0"',
    }),
